...
def create_and_run_backtest(strategy_output, trading_idea, filename_base):
    ...
    backtest_output = create_and_run_assistant(
        ...
        instructions='Code a backtest in python for the provided trading strategy using backtesting.py, output only the code of the backtest, do not execute the backtest',
        model=model,
